...
#define XQC_FRAME_BIT_PATH_CIDS_BLOCKED       ((xqc_frame_type_bit_t)1ULL << XQC_FRAME_PATH_CIDS_BLOCKED)
...
_Static_assert(XQC_FRAME_BIT_PATH_CIDS_BLOCKED == ((xqc_frame_type_bit_t)1ULL << XQC_FRAME_PATH_CIDS_BLOCKED),
