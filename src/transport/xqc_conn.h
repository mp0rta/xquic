...
#define XQC_CONN_FLAG_WAIT_WAKEUP           ((uint64_t)1ULL << XQC_CONN_FLAG_WAIT_WAKEUP_SHIFT)
#define XQC_CONN_FLAG_HANDSHAKE_COMPLETED   ((uint64_t)1ULL << XQC_CONN_FLAG_HANDSHAKE_COMPLETED_SHIFT)
#define XQC_CONN_FLAG_CAN_SEND_1RTT         ((uint64_t)1ULL << XQC_CONN_FLAG_CAN_SEND_1RTT_SHIFT)
#define XQC_CONN_FLAG_TICKING               ((uint64_t)1ULL << XQC_CONN_FLAG_TICKING_SHIFT)
#define XQC_CONN_FLAG_ACK_HAS_GAP           ((uint64_t)1ULL << XQC_CONN_FLAG_ACK_HAS_GAP_SHIFT)
#define XQC_CONN_FLAG_TIME_OUT              ((uint64_t)1ULL << XQC_CONN_FLAG_TIME_OUT_SHIFT)
#define XQC_CONN_FLAG_ERROR                 ((uint64_t)1ULL << XQC_CONN_FLAG_ERROR_SHIFT)
#define XQC_CONN_FLAG_DATA_BLOCKED          ((uint64_t)1ULL << XQC_CONN_FLAG_DATA_BLOCKED_SHIFT)
#define XQC_CONN_FLAG_DCID_OK               ((uint64_t)1ULL << XQC_CONN_FLAG_DCID_OK_SHIFT)
#define XQC_CONN_FLAG_TOKEN_OK              ((uint64_t)1ULL << XQC_CONN_FLAG_TOKEN_OK_SHIFT)
#define XQC_CONN_FLAG_HAS_0RTT              ((uint64_t)1ULL << XQC_CONN_FLAG_HAS_0RTT_SHIFT)
#define XQC_CONN_FLAG_0RTT_OK               ((uint64_t)1ULL << XQC_CONN_FLAG_0RTT_OK_SHIFT)
#define XQC_CONN_FLAG_0RTT_REJ              ((uint64_t)1ULL << XQC_CONN_FLAG_0RTT_REJ_SHIFT)
#define XQC_CONN_FLAG_UPPER_CONN_EXIST      ((uint64_t)1ULL << XQC_CONN_FLAG_UPPER_CONN_EXIST_SHIFT)
#define XQC_CONN_FLAG_INIT_RECVD            ((uint64_t)1ULL << XQC_CONN_FLAG_INIT_RECVD_SHIFT)
#define XQC_CONN_FLAG_NEED_RUN              ((uint64_t)1ULL << XQC_CONN_FLAG_NEED_RUN_SHIFT)
#define XQC_CONN_FLAG_PING                  ((uint64_t)1ULL << XQC_CONN_FLAG_PING_SHIFT)
#define XQC_CONN_FLAG_HSK_ACKED             ((uint64_t)1ULL << XQC_CONN_FLAG_HSK_ACKED_SHIFT)
#define XQC_CONN_FLAG_RESERVE               ((uint64_t)1ULL << XQC_CONN_FLAG_RESERVE_SHIFT)
#define XQC_CONN_FLAG_HANDSHAKE_DONE_RECVD  ((uint64_t)1ULL << XQC_CONN_FLAG_HANDSHAKE_DONE_RECVD_SHIFT)
#define XQC_CONN_FLAG_UPDATE_NEW_TOKEN      ((uint64_t)1ULL << XQC_CONN_FLAG_UPDATE_NEW_TOKEN_SHIFT)
#define XQC_CONN_FLAG_VERSION_NEGOTIATION   ((uint64_t)1ULL << XQC_CONN_FLAG_VERSION_NEGOTIATION_SHIFT)
#define XQC_CONN_FLAG_HANDSHAKE_CONFIRMED   ((uint64_t)1ULL << XQC_CONN_FLAG_HANDSHAKE_CONFIRMED_SHIFT)
#define XQC_CONN_FLAG_HANDSHAKE_DONE_ACKED  ((uint64_t)1ULL << XQC_CONN_FLAG_HANDSHAKE_DONE_ACKED_SHIFT)
#define XQC_CONN_FLAG_ADDR_VALIDATED        ((uint64_t)1ULL << XQC_CONN_FLAG_ADDR_VALIDATED_SHIFT)
#define XQC_CONN_FLAG_LINGER_CLOSING        ((uint64_t)1ULL << XQC_CONN_FLAG_LINGER_CLOSING_SHIFT)
#define XQC_CONN_FLAG_RETRY_RECVD           ((uint64_t)1ULL << XQC_CONN_FLAG_RETRY_RECVD_SHIFT)
#define XQC_CONN_FLAG_TLS_CH_RECVD          ((uint64_t)1ULL << XQC_CONN_FLAG_TLS_CH_SHIFT)
#define XQC_CONN_FLAG_TLS_HSK_COMPLETED     ((uint64_t)1ULL << XQC_CONN_FLAG_TLS_HSK_COMPLETED_SHIFT)
#define XQC_CONN_FLAG_RECV_NEW_PATH         ((uint64_t)1ULL << XQC_CONN_FLAG_RECV_NEW_PATH_SHIFT)
#define XQC_CONN_FLAG_VALIDATE_REBINDING    ((uint64_t)1ULL << XQC_CONN_FLAG_VALIDATE_REBINDING_SHIFT)
#define XQC_CONN_FLAG_CLOSING_NOTIFY        ((uint64_t)1ULL << XQC_CONN_FLAG_CONN_CLOSING_NOTIFY_SHIFT)
#define XQC_CONN_FLAG_CLOSING_NOTIFIED      ((uint64_t)1ULL << XQC_CONN_FLAG_CONN_CLOSING_NOTIFIED_SHIFT)
#define XQC_CONN_FLAG_DGRAM_WAIT_FOR_1RTT   ((uint64_t)1ULL << XQC_CONN_FLAG_DGRAM_WAIT_FOR_1RTT_SHIFT)
#define XQC_CONN_FLAG_LOCAL_TP_UPDATED      ((uint64_t)1ULL << XQC_CONN_FLAG_LOCAL_TP_UPDATED_SHIFT)
#define XQC_CONN_FLAG_PMTUD_PROBING         ((uint64_t)1ULL << XQC_CONN_FLAG_PMTUD_PROBING_SHIFT)
#define XQC_CONN_FLAG_NO_DGRAM_NOTIFIED     ((uint64_t)1ULL << XQC_CONN_FLAG_NO_DGRAM_NOTIFIED_SHIFT)
#define XQC_CONN_FLAG_DGRAM_MSS_NOTIFY      ((uint64_t)1ULL << XQC_CONN_FLAG_DGRAM_MSS_NOTIFY_SHIFT)
#define XQC_CONN_FLAG_MP_WAIT_MP_READY      ((uint64_t)1ULL << XQC_CONN_FLAG_MP_WAIT_MP_READY_SHIFT)
#define XQC_CONN_FLAG_MP_READY_NOTIFY       ((uint64_t)1ULL << XQC_CONN_FLAG_MP_READY_NOTIFY_SHIFT)
#define XQC_CONN_FLAG_HANDSHAKE_DONE_SENT   ((uint64_t)1ULL << XQC_CONN_FLAG_HANDSHAKE_DONE_SENT_SHIFT)
#define XQC_CONN_FLAG_SERVER_ACCEPT         ((uint64_t)1ULL << XQC_CONN_FLAG_SERVER_ACCEPT_SHIFT)
#define XQC_CONN_FLAG_RETRY_SENT            ((uint64_t)1ULL << XQC_CONN_FLAG_RETRY_SENT_SHIFT)
...
_Static_assert(XQC_CONN_FLAG_MP_WAIT_MP_READY == ((uint64_t)1ULL << 38),
               "XQC_CONN_FLAG_MP_WAIT_MP_READY must be bit 38");
_Static_assert(XQC_CONN_FLAG_MP_READY_NOTIFY == ((uint64_t)1ULL << 39),
               "XQC_CONN_FLAG_MP_READY_NOTIFY must be bit 39");
_Static_assert(XQC_CONN_FLAG_RETRY_SENT == ((uint64_t)1ULL << 42),
