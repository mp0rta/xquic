...
main()
{
    ...
    if (!CU_add_test(pSuite, "xqc_test_get_random", xqc_test_get_random)
        ...
        || !CU_add_test(pSuite, "test_mp21_version_enum", xqc_test_mp21_version_enum)
        || !CU_add_test(pSuite, "test_mp21_frame_type_constants", xqc_test_mp21_frame_type_constants)
